        ...
        <div className="container mt-4">
            ...
            <div className="card p-4">
                <div className="row mb-3">
                    <div className="col-sm-3"><strong>항공편 번호:</strong></div>
                    <div className="col-sm-9">{flight.flightNumber}</div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-3"><strong>출발 시간:</strong></div>
                ...
                <div className="row mb-3">
                    <div className="col-sm-3"><strong>도착 시간:</strong></div>
                ...
                <div className="row mb-3">
                    <div className="col-sm-3"><strong>출발 공항:</strong></div>
                    <div className="col-sm-9">{flight.departureAirport}</div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-3"><strong>도착 공항:</strong></div>
                    <div className="col-sm-9">{flight.arrivalAirport}</div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-3"><strong>총 좌석 수:</strong></div>
                    <div className="col-sm-9">{flight.flightTotalSeat}</div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-3"><strong>상태:</strong></div>
